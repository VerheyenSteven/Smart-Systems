...
int RledState = 0;                      //de status van de rechter led
int LledState = 0;                      //de status van de linker led
...
bool vooruitRijden = false;                 // de bools die worden aangepast van de RF, hierdoor zal de auto rijden of andere manuevers maken
bool achteruitRijden= false;
bool linksRijden = false;
bool rechtsRijden = false;
bool rechtsKijken = false;
bool vooruitKijken = true;
